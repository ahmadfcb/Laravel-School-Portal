...
<html lang="en-us" id="extr-page">
    <head>
        ...
        <!-- #CSS Links -->
        <!-- Basic Styles -->
        <link rel="stylesheet" type="text/css" media="screen" href="{{ asset('ap/css/bootstrap.min.css') }}">
        <link rel="stylesheet" type="text/css" media="screen" href="{{ asset('ap/css/font-awesome.min.css') }}">
    ...
    <body class="animated fadeInDown">
        ...
        <header id="header">
            ...
            <div id="logo-group">
                <span id="logo"> <img src="{{ asset('ap/img/logo.png') }}" alt="{{ config('app.name') }}"> </span>
            </div>

            <span id="extr-page-header-space">
                {{--<span class="hidden-mobile hiddex-xs">Need an account?</span> <a href="register.html" class="btn btn-danger">Create account</a>--}}
            </span>
            ...
            <div id="content" class="container">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-7 col-lg-8 hidden-xs hidden-sm">
                        <h1 class="txt-color-red login-header-big">{{ config('app.name') }}</h1>
                        <div class="hero">
                            ...
                            {{--<img src="{{ asset('ap/img/demo/iphoneview.png') }}" class="pull-right display-image" alt="" style="width:210px">--}}
        ...
        <script src="{{ asset('ap/js/plugin/pace/pace.min.js') }}"></script>

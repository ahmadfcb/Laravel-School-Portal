            ...
            <div class="jarviswidget" id="wid-id-0">
                ...
                <div>
                    ...
                    <div class="widget-body">
                        ...
                        <form action="{{ route('dashboard.student_withdraw', ['student' => $student->id]) }}" method="post">
                            {{ csrf_field() }}
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="certificate_issued" value="1" {{ old('certificate_issued', '0') == '1' ? 'checked' : '' }}> Yes
                                        </label>

                                        <label>
                                            <input type="radio" name="certificate_issued" value="0" {{ old('certificate_issued', '0') == '0' ? 'checked' : '' }}> No
                                        </label>
                                    </div>
                                </div>
                            </fieldset>
